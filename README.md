...
Think of it as a parking lot. You say "park" when you're done for now, and Park leaves you a labeled spot — a state doc plus a paste-able resume prompt — that you can pull back into whenever.
